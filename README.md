...
## Visualisation
The current Tech Radar can be viewed [here](https://radar.thoughtworks.com/?sheetId=https://git.nonprod.williamhill.plc/imacdonald/sqcop-tech-radar/raw/master/qa-tech-radar.csv) using the web application provided by ThoughtWorks.
